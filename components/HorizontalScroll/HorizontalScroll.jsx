...
const TEXT = "Yeni Projenize Başlamaya Hazır Mısınız?";
...
const HorizontalScroll = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Tie background gradient position to scroll
      gsap.to(wrapper, {
      ...
      // Transition text to dark as background becomes white
      gsap.to(text, {
        color: "#000000",
        ease: "none",
        scrollTrigger: {
  ...
  return (
    <section className="Horizontal" ref={wrapperRef}>
      <div className="hs-sticky" ref={stickyRef}>
        <SectionSkiggle type="horizontal" color="#050B14" />
        <h3 className="Horizontal__text heading-xl relative z-10" ref={textRef}>
          {renderText()}
        </h3>
      </div>
    </section>
