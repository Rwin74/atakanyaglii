  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 font-bold tracking-widest group-hover:scale-105 transition-transform">
          {children}
        </div>
        <GlassFilter />
      </Comp>
...
const colorVariants = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-blue-700 via-blue-600 to-blue-300",
  ...
  instagram: {
    outer: "bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888]",
    inner: "bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888]",
    button: "bg-gradient-to-tr from-[#f09433]/80 via-[#dc2743]/80 to-[#bc1888]/80",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(188_24_136_/_100%)]",
  },
  linkedin: {
    outer: "bg-gradient-to-b from-[#0077b5] to-[#004471]",
    inner: "bg-gradient-to-b from-[#0077b5] via-[#005582] to-[#00334f]",
    button: "bg-gradient-to-b from-[#0077b5]/90 to-[#004471]/90",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(0_119_181_/_100%)]",
  },
};
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      "relative z-10 m-[1px] rounded-full inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden px-6 py-2 text-sm tracking-widest font-semibold will-change-transform outline-none",
      colors.button,
      colors.textColor,
      colors.textShadow,
    ),
...
export const MetalButton = React.forwardRef(({ children, className, buttonClassName, variant = "default", ...props }, ref) => {
  ...
  return (
    <div className={cn(variants.wrapper, className)} style={variants.wrapperStyle}>
      ...
      <button
        ref={ref}
        className={cn(variants.button, buttonClassName)}
