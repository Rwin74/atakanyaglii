...
const Skiggle = () => {
  ...
  const [pathLength, setPathLength] = useState(6000);
  ...
  return (
    <svg
      className="squigggle absolute top-[-10%] left-1/2 -translate-x-1/2 w-[120vw] h-[110%] z-0 overflow-visible"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <motion.path
        ref={pathRef}
        d="M 400 2200 C 1000 2000, 1600 1500, 1588 1052.5 C 1563.5 1002.5 1503.4 1295.7 1413 1288.5 C 1300 1279.5 1318.5 976.5 1145.5 942.5 C 972.5 908.501 1011.5 1109.5 827 1142.5 C 642.5 1175.5 640.5 963.5 366 804 C 146.4 676.4 73.1667 792.5 64 866.5 C 65.5 916.5 106.8 1011.8 260 993 C 396 976.311 647.5 927.5 677.5 547.5 C 707.5 167.5 246.5 -47 82.5 66 C -81.5 179 -189.5 31.5 -189.5 31.5"
        style={{
